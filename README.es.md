...
![Vista de la Pizarra de Mandos](https://placehold.co/1000x500/1e293b/94a3b8?text=Interfaz+Administradora)
...
```mermaid
graph TD;
    A[Dispositivo de Alumno] -->|WebSockets/HTML| B(Enrutador Elysia.js);
    B <--> C[(Archivero MySQL)];
    B --> D[Gaveta de Culpabilidad Evidencias];
    E[Mando Presidencial Admin] <-->|Real-Time WS| B;
```
